...
contract CoinFlipper {
    ...
    function betAndFlip() public payable            
    {
  	...
  	function getLastBlockNumberUsed() constant public returns (uint)
    {
        return lastblocknumberused;
    }
    
    function getLastBlockHashUsed() constant public returns (bytes32)
    {
    	return lastblockhashused;
    }

    function getResultOfLastFlip() constant public returns (string)
    {
    	return lastresult;
    }
    
    function getPlayerGainLossOnLastFlip() constant public returns (int)
    {
    	return lastgainloss;
    }
