...
import './FETCKeysCalcLong.sol';
import './FETCdatasets.sol';
contract FETCevents {
...
contract FomoETClong is modularLong {
    ...
    DiviesInterface constant private Divies = DiviesInterface(0xf721cFdDDD62d28Fbf01938E98EAB41aAa283027);
    MagicPowerForwarderInterface constant private MagicPowerForwarder = MagicPowerForwarderInterface(0x345bcC7a34314494Cfdad5927975A443BeA6604a);
	PlayerBookInterface constant private PlayerBook = PlayerBookInterface(0x134Ab88d841555D2eC446cd866E6E043dd1DBE2f);
